...
#define STRING_CONFIG_H_AUTHOR "(Dust, Ender-3 Pro) Tweaked by HarrierPigeon" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E3Pro Shh+BLT"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -60, -20, 0 }
